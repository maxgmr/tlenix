...
pub struct Termios {
    ...
    pub input_mode_flags: InputModeFlags,
    /// The terminal output mode flags.
    pub output_mode_flags: OutputModeFlags,
    /// The terminal local mode flags.
    pub local_mode_flags: LocalModeFlags,
    /// The terminal control mode flags.
    pub control_mode_flags: ControlModeFlags,
    /// The terminal line discipline.
    pub line_discipline: LineDiscipline,
    /// List of control character definitions.
    pub control_characters: [u8; TERMIOS_CC_SIZE],
    /// The input baud rate.
    pub input_baud_rate: u32,
    /// The output baud rate.
    pub output_baud_rate: u32,
}
impl Termios {
